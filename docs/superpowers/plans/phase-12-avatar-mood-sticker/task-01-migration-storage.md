# Task 01 — DB Migration & Storage Buckets

**Files:**

- Create: `supabase/migrations/20260429200000_add_avatar_mood_sticker.sql`
...
- [ ] **Step 3:** Thêm `OPENROUTER_API_KEY` vào Supabase edge function secrets.
...
```bash
git add supabase/migrations/20260429200000_add_avatar_mood_sticker.sql
git commit -m "feat: add avatar mood sticker schema and storage buckets"
```
