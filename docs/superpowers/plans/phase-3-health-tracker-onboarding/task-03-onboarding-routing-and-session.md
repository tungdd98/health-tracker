...
- [x] **Step 1: Extend the auth-session hook with normalized onboarding state**
...
- [x] **Step 2: Add onboarding-aware route guards**
...
- [x] **Step 3: Add the onboarding page route**
...
- [x] **Step 4: Keep the post-onboarding home lightweight**
...
- [x] **Step 5: Lint the routing changes**
...
- [x] **Step 6: Commit the onboarding-aware routing**
