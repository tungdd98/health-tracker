...
For any task involving UI components, do NOT include in the plan:

- JSX markup samples
- CSS / Tailwind class details
- Inline styling decisions
- Color / spacing / typography specifics
- Component prop schemas with type definitions

DO include:

- Which component(s) to create or modify (by name + file path)
- Data flow: what props/state flow in, what events flow out
- Which existing component/pattern to follow (link to file)
- Reference to the design source (Figma/mockup link, ticket attachment)

Rule: the plan describes WHAT components and data flow exist, not HOW
they look. Visual decisions belong in the implementation, not the plan.
...
**4. UI verbosity check:** For UI tasks, does the plan describe components + data flow only? No JSX, CSS, or styling specifics? If found, strip them.
